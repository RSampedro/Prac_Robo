...
%--------------------------------------------------------------------------
    ...
    theta_1 = linspace(theta_init(1),theta_target(1),frames);
    theta_2 = linspace(theta_init(2),theta_target(2),frames);
    theta_3 = linspace(theta_init(3),theta_target(3),frames);
    theta_4 = linspace(theta_init(4),theta_target(4),frames);
    theta_5 = linspace(theta_init(5),theta_target(5),frames);
    theta_6 = linspace(theta_init(6),theta_target(6),frames);
    ...
    %Hacemos todos los incrementos de la theta_init a la theta_target
    auxt =  linspace(1,frames,frames);

    theta_1 = interp1([auxt(1) auxt(uint8(frames/2)) auxt(frames)],[theta_1(1) theta_1(uint8(frames/2))+norm(theta_1(uint8(frames/2))-theta_1(frames)) theta_1(frames)],auxt,'spline');
    theta_2 = interp1([auxt(1) auxt(uint8(frames/2)) auxt(frames)],[theta_2(1) theta_2(uint8(frames/2))+norm(theta_2(uint8(frames/2))-theta_2(frames)) theta_2(frames)],auxt,'spline');
    theta_3 = interp1([auxt(1) auxt(uint8(frames/2)) auxt(frames)],[theta_3(1) theta_3(uint8(frames/2))+norm(theta_3(uint8(frames/2))-theta_3(frames)) theta_3(frames)],auxt,'spline');
    theta_4 = interp1([auxt(1) auxt(uint8(frames/2)) auxt(frames)],[theta_4(1) theta_4(uint8(frames/2))+norm(theta_4(uint8(frames/2))-theta_4(frames)) theta_4(frames)],auxt,'spline');
    theta_5 = interp1([auxt(1) auxt(uint8(frames/2)) auxt(frames)],[theta_5(1) theta_5(uint8(frames/2))+norm(theta_5(uint8(frames/2))-theta_5(frames)) theta_5(frames)],auxt,'spline');
    theta_6 = interp1([auxt(1) auxt(uint8(frames/2)) auxt(frames)],[theta_6(1) theta_6(uint8(frames/2))+norm(theta_6(uint8(frames/2))-theta_6(frames)) theta_6(frames)],auxt,'spline');
    theta = [theta_1 ; theta_2 ; theta_3 ; theta_4 ; theta_5 ; theta_6];
...
function result = display_joints_points(pos)
